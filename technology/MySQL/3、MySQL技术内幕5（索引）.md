...
![完全二叉树](pictures/3）5.2.2-1.png)

![满二叉树](pictures/3）5.2.2-2.png)
...
![插入操作规则](pictures/3）5.3.1-1.png)

页的拆分意味着磁盘的操作，在插入过程中，B+ 树为了减少页的拆分操作，同样提供了类似于平衡二叉树的旋转功能。

![删除操作规则](pictures/3）5.3.1-2.png)
...
![B+ 树存储的最多叶子节点](pictures/3）5.4.1-1.png)
...
![辅助索引和聚集索引的关系](pictures/3）5.4.1-2.png)

![辅助索引和聚集索引的关系 —— 实例](pictures/3）5.4.1-3.png)
...
![img.png](pictures/3）5.4.5.1-1.png)
...
![img.png](pictures/3）5.7.1-1.png)

注意，下表中 Number 为 1，对应的 Text 应为 cold，系打印错误。

![img.png](pictures/3）5.7.1-2.png)

![img.png](pictures/3）5.7.1-3.png)
